...
export class CourseGroupsController {
  ...
  @ApiOperation({
    ...
    description: 'Administrators can create new course groups for a specific period'
  })
  @ApiResponse({ status: 201, description: 'Course group created successfully' })
  @ApiResponse({ status: 400, description: 'Invalid data or group already exists' })
  ...
  @ApiOperation({
    ...
    description: 'Retrieve all course groups with course and period information'
  })
  @ApiResponse({ status: 200, description: 'Course groups retrieved successfully' })
  ...
  @ApiResponse({ status: 200, description: 'Available groups retrieved successfully' })
  @Get('available')
  async getAvailable(
  ...
  @ApiOperation({
    ...
    description: 'Update course group information including capacity and professor'
  })
  @ApiParam({ name: 'id', description: 'Course group ID' })
  ...
  @ApiResponse({ status: 400, description: 'Cannot delete group with enrolled students' })
  @ApiResponse({ status: 404, description: 'Course group not found' })
  ...
  @ApiParam({ name: 'id', description: 'Course group ID' })
  @ApiResponse({ status: 200, description: 'Enrollment count updated successfully' })
  @RequirePermissions(Permission.UPDATE_COURSE)
